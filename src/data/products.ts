...
export const products: Product[] = [
  {
    id: "592344",
    name: "Kit Potes Herméticos MaxLock",
    price: 89.90,
    originalPrice: 179.80,
    image: "https://qtbkvshbmqlszncxlcuc.supabase.co/storage/v1/object/public/dsl-uploads/pwa8foyadnbKd8zeVI2fSe3qwT93/1fd9fd69-67e5-4721-88cd-6a3f483f470a.png",
    images: [
      "https://qtbkvshbmqlszncxlcuc.supabase.co/storage/v1/object/public/dsl-uploads/pwa8foyadnbKd8zeVI2fSe3qwT93/1fd9fd69-67e5-4721-88cd-6a3f483f470a.png",
      "https://qtbkvshbmqlszncxlcuc.supabase.co/storage/v1/object/public/dsl-uploads/pwa8foyadnbKd8zeVI2fSe3qwT93/8d32efee-7109-4014-abf6-a59606941674.png",
      "https://qtbkvshbmqlszncxlcuc.supabase.co/storage/v1/object/public/dsl-uploads/pwa8foyadnbKd8zeVI2fSe3qwT93/fa10951f-55a9-48c7-b7f2-fb5e7ee5ec66.png",
      "https://qtbkvshbmqlszncxlcuc.supabase.co/storage/v1/object/public/dsl-uploads/pwa8foyadnbKd8zeVI2fSe3qwT93/c194a438-53d7-485a-a764-3c02aca3cdcb.png",
    ],
    category: "Cozinha",
    rating: 4.9,
    reviews: 34,
    description: "## Mantenha seus alimentos frescos por muito mais tempo!\n\nO Kit de Potes Herméticos MaxLock é a solução definitiva para organizar sua cozinha e preservar o sabor e a textura dos seus alimentos. Com tecnologia de vedação absoluta, eles impedem a entrada de ar e umidade, evitando o desperdício.\n\n## Por que escolher o MaxLock?\n\n✓ **Vedação 100% Hermética** — Sistema de travas nos quatro lados que garante isolamento total.\n✓ **Material Premium** — Plástico ultra resistente, livre de BPA (BPA Free), seguro para sua família.\n✓ **Design Inteligente** — Empilháveis para otimizar o espaço no seu armário ou geladeira.\n✓ **Multiuso** — Podem ir ao freezer e geladeira.\n✓ **Transparência Total** — Visualize o conteúdo sem precisar abrir.\n\n## Organização e Saúde\nAlimentos expostos perdem nutrientes e atraem insetos. Com o MaxLock, você mantém grãos, cereais, massas, biscoitos e frutas frescos e protegidos.\n\n## Garantia\n30 dias contra defeitos de fabricação.",
    features: ["BPA Free", "Vedação Hermética Total", "Pode ir ao Freezer", "Material Ultra Resistente"],
    inStock: true,
    badge: "OFERTA",
    zuckHash: "592344",
    options: [
      {
        name: "Quantidade",
        variants: [
          { label: "14 Potes Hérmeticos", price: 89.90, originalPrice: 179.80, imageIndex: 1, stock: 4 },
          { label: "24 Potes Hérmeticos", price: 109.90, originalPrice: 219.80, imageIndex: 2, stock: 7 },
        ],
      },
    ],
  },
    ...
    options: [
      {
        name: "Opção",
        variants: [
          { label: "Personalizado Com Garrafa", price: 169.90, originalPrice: 326.90, imageIndex: 0, stock: 3 },
          { label: "Personalizado Sem Garrafa", price: 149.90, originalPrice: 241.90, imageIndex: 1, stock: 12 },
          { label: "Sem Personalizar Com Garrafa", price: 159.90, originalPrice: 313.90, imageIndex: 2, stock: 5 },
          { label: "Sem Personalizar Sem Garrafa", price: 139.90, originalPrice: 240.90, imageIndex: 3, stock: 18 },
        ],
      },
    ],
  },
...
reviews: 576,
    ...
    options: [
      {
        name: "Cor",
        variants: [
          { label: "Marrom", price: 127.80, originalPrice: 187.90, imageIndex: 0, stock: 9 },
          { label: "Branco", price: 127.80, originalPrice: 187.90, imageIndex: 2, stock: 4 },
        ],
      },
    ],
  },
  {
    id: "15",
    name: "Panela de Pressão de Pedra Sabão + Brinde Especial",
    price: 129.90,
    ...
    rating: 4.9,
reviews: 14,
    description: "## Panela de Pressão de Pedra Sabão Natural - Comida Sempre Quentinha e Saudável\n\nNossa panela de Pressão de pedra sabão é a escolha perfeita para quem busca uma alimentação saudável e quer manter os alimentos sempre quentinhos! Feita 100% com pedra sabão natural, sem metais pesados, essa panela preserva o sabor dos alimentos e libera minerais essenciais para o corpo.\n\n## Especificações da Panela de Pressão:\n\n- **Matéria Prima:** Pedra Sabão, nome científico: Esteatita\n- **Acompanha:** Alças e contorno de cobre, metal nobre fixos na panela.\n- **Acompanha:** Tampa de pedra sabão\n- Este anúncio possui variações para o cliente escolher o tamanho da Panela. Certifique-se de selecionar o tamanho desejado antes de finalizar a compra.\n- **OBS:** A panela de pressão de pedra por ser natural e 100% artesanal pode incluir variações em seu processo de fabricação, incluindo: o formato e medidas. Tanto um pouco para mais ou um pouco para menos\n- A pedra sabão por ser um produto natural possui veios naturais, que está presente em 95% da rocha, sendo uma característica comum da pedra sabão, sendo somente estética isso não afetara na durabilidade e nem na funcionalidade da panela\n\n## O que pode ser feita na panela de pressão de pedra sabão?\n\n- Feijão\n- Carnes\n- Sopas e caldos\n- Legumes\n- Arroz de carreteiro e risotos\n- Você pode usar sua panela de pressão de pedra como se fosse uma panela de pressão convencional, pode fazer de tudo.\n\n## Benefícios da Panela de pressão de pedra sabão:\n\n- **ZERO risco de explosão** — 100% segura\n- **Libera:** Ferro, Cálcio, Magnésio e Manganês durante o cozimento\n- **Realça o sabor dos alimentos**\n- **Antiaderente natural** (sem teflon ou produtos químicos)\n- **Não libera toxinas** — segurança total para a saúde\n\n## A sua panela de pressão de pedra pode ser usada em:\n\n- Fogões convencionais, doméstico e cooktops\n- Fogões a lenha, elétricos e com resistência\n- Fornos de todos os tipos (exceto micro-ondas)\n- Fogareiros e réchauds\n- Banho Maria\n- Não funciona em fogão de indução\n\n## Instruções de limpeza da sua panela de pressão de pedra sabão:\n\nA panela de pressão de pedra por ser antiaderente natural é mais fácil de limpar do que as panelas convencionais – basta usar água, sabão ou detergente e uma esponja de sua preferência.",
    ...
    options: [
      {
        name: "Tamanho",
        variants: [
          { label: "4L", price: 129.90, originalPrice: 219.90, imageIndex: 0, stock: 4 },
          { label: "6L", price: 149.90, originalPrice: 249.90, imageIndex: 0, stock: 5 },
          { label: "8L", price: 179.90, originalPrice: 352.90, imageIndex: 1, stock: 2 },
          { label: "11L", price: 229.90, originalPrice: 376.90, imageIndex: 1, stock: 3 },
        ],
      },
    ],
  },
    ...
    options: [
      {
        name: "Cor",
        variants: [
          { label: "Rosa", price: 15.90, originalPrice: 59.90, imageIndex: 0 },
          { label: "Cinza", price: 15.90, originalPrice: 59.90, imageIndex: 1 },
          { label: "Branco", price: 15.90, originalPrice: 59.90, imageIndex: 3 },
        ],
      },
    ],
  },
    ...
    options: [
      {
        name: "Cor",
        variants: [
          { label: "Rosa", price: 67.90, originalPrice: 179.90, imageIndex: 1 },
          { label: "Azul", price: 67.90, originalPrice: 179.90, imageIndex: 5 },
          { label: "Vermelho", price: 67.90, originalPrice: 179.90, imageIndex: 3 },
          { label: "Preto", price: 67.90, originalPrice: 179.90, imageIndex: 6 },
        ],
      },
    ],
  },
...
reviews: 137,
    ...
    options: [
      {
        name: "Cor",
        variants: [
          { label: "Vermelho", price: 29.90, originalPrice: 129.90, imageIndex: 0 },
          { label: "Preto", price: 29.90, originalPrice: 129.90, imageIndex: 1 },
        ],
      },
    ],
  },
  ...
  {
    id: "24",
    name: "Porta Tempero Giratório Vidro e Inox",
    price: 29.90,
    originalPrice: 219.90,
...
reviews: 306,
    ...
    options: [
      {
        name: "Modelo",
        variants: [
          { label: "Alumínio 16", price: 129.90, originalPrice: 219.90, imageIndex: 0 },
          { label: "Alumínio 12", price: 39.90, originalPrice: 219.90, imageIndex: 1 },
          { label: "Madeira", price: 29.90, originalPrice: 219.90, imageIndex: 2 },
        ],
      },
    ],
  },
  {
    id: "25",
    name: "Porta Tempero Giratório 6 Potes Rústico",
    price: 29.90,
    ...
    rating: 4.8,
reviews: 180,
    description: "## Porta Tempero Giratório Rústico — 6 Potes\n\nUm verdadeiro charme para a cozinha. Este porta condimentos une beleza e praticidade do sistema giratório, deixando seus temperos sempre à mão.\n\n## ESPECIFICAÇÕES TÉCNICAS\n• **Material dos potes:** Vidro transparente\n• **Tampas:** Metal with vedação\n• **Quantidade:** 6 potes\n• **Sistema:** Giratório 360°\n\n## DESTAQUES\n✓ Gira suavemente em 360°\n✓ Potes de vidro com alça lateral em metal\n✓ Tampas que fecham com firmeza para conservar o aroma\n✓ Design rústico que valoriza a decoração\n\n## CONTEÚDO DA EMBALAGEM\n• 1 Suporte giratório\n• 6 Potes de vidro with tampa metálica",
    features: ["6 potes giratórios", "Design elegante", "Acesso 360°", "Tampas com vedação"],
    inStock: true,
    badge: "OFERTA",
    options: [
      {
        name: "Material",
        variants: [
          { label: "Madeira", price: 29.90, originalPrice: 159.90, imageIndex: 0 },
          { label: "Alumínio", price: 59.90, originalPrice: 159.90, imageIndex: 1 },
        ],
      },
    ],
  },
...
reviews: 393,
  ...
  {
    id: "27",
    name: "Cestos Organizadores Multiuso 4 Peças",
    price: 49.90,
