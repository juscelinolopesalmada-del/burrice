    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="text-xs text-muted-foreground mb-6 flex gap-2">
          ...
          <span>/</span>
          <span className="text-foreground">{currentCategory?.name || "Ofertas Especiais"}</span>
        </nav>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-6">
              <p className="text-sm text-muted-foreground">{filtered.length} produtos em oferta</p>
